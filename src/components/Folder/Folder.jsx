...
export default function Folder(props) {
  ...
  return (
    <div onClick={handleClick} className="ml-5 bg-[#ffffff] border-1 mt-5 h-10 w-11/12 rounded-md hover:bg-gray-100 md:w-4/12  lg:w-2/12 px-2  " onContextMenu={handleRightClick}>
